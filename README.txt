...
OVERVIEW:
The Photo Resizer is a simple program designed to resize all .jpg and .jpeg images in a specified directory to a resolution of 1600x1200 pixels. The resized images are saved in a subdirectory named resized.
---------------------------------------------------------------------------------------------------------------------------------------
...
Each photo will be resized to 1600x1200px.
